...
<body>
	<div id="container ">
	   <nav class="navbar navbar-inverse">
		...
		<div class="content">
			<h2>Print</h2>
			<div>&nbsp<a href="add/"><button class="btn btn-success">Add Print</button></a></div>
			<div class="table-responsive">
				<table class="table">
					...
					<tbody>
						<c:forEach var="current" items="${prints}">
							<tr>
								<td>${current.user.completeName }</td>
								<td>${current.pedigree.name }</td>
								<td>${current.dateIssue}</td>
